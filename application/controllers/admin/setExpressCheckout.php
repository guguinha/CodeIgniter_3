...
class SetExpressCheckout extends CI_Controller {
...
//require 'sendNvpRequest.php';
  $this->load->model('sendNvpRequest_model');
...
if ($sandbox) {
    ...
    $user = 'guguguim-facilitator_api1.hotmail.com';

    $pswd = 'V5P2WRJ7CLFJ3L73';

    $signature = 'AUT0HHlrYTHIzwf.mOsUkWTRm6VQAWYm.sWFWK5Qwf7soSywa9mNL6F2';
...
$requestNvp = array(
    ...
    'PAYMENTREQUEST_0_INVNUM' => '1234', //numero do pedido para identificação
...
$responseNvp = $this->sendNvpRequest_model->sendNvpRequest($requestNvp, $sandbox);
